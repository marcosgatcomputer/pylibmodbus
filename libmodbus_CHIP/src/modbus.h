...
MODBUS_API int modbus_configure_rpi_bcm_pin(modbus_t *ctx, uint16_t value);
MODBUS_API int modbus_configure_rpi_bcm_pins(modbus_t *ctx, uint16_t de, uint16_t re);
